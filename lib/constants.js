...
// Logistic model parameters from Monte Carlo simulation (Paper 242, Appendix A1).
// These are simulation assumptions, not runtime constants. The live model uses
// pre-computed probability tables; these values are used only for display and
// documentation. Do not change without re-running the simulation.
export const LOGISTIC_ALPHA = -2.197;
export const LOGISTIC_BETA  =  0.811;
